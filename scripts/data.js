const items = [
  ...
  },
  {
    ...
    text: `Vincent Chin went to Fancy Pants, a topless bar, in Detroit with three of his friends. Ronald Ebens, a superintendent for Chrysler, and his stepson Michael Nitz, who was recently laid off after working in the auto industry, got into a fight with Chin. Dancers heard Ebens say, 'It's because of you motherf*ckers that we're out of work,' and Vincent replied, 'Don't call me a f*cker.' They were separated and removed from the bar. Ebens and Nitz continued looking for Chin afterwards, paying a man $20 to help 'get the Chinese.' After driving for around half an hour, they found Vincent with a friend outside of McDonalds. Ebens beat Vincent with a baseball bat while Nitz held him down in a bear hug. 2 off-duty police officers came and told Ebens to drop the bat.`
  },
  {
    date: "23 June 1982",
    title: "Vincent Chin's Death",
    subtitle: `4 days later, Vincent Chin dies in the hospital`,
    text: `Vincent Chin was mortally wounded from the blows. Blood, spinal fluid, and chunks of brain matter were lying on the sidewalk as Ebens and Nitz left. His last words before falling into a coma were 'It's not fair.' He never regained consciousness before dying four days later. He was supposed to be getting married in 2 days; instead, his wedding guests attended his funeral.`
  },
  {
    date: "16 March 1983",
    title: "The Court Decides",
    subtitle: `Ebens and Nitz face 3 years' probation and $3,780 in fines`,
    text: `Nine months later, the Wayne County Court, presided by Judge Charles Kaufman, came to a conclusion. Ebens pleaded guilty and Nitz pleaded no-contest to manslaughter in a plea-bargain; they were originally charged for 2nd-degree murder. Each received three years of probation and $3,780 in fines and court costs. Judge Kaufman reasoned, "These aren't the kind of men you send to jail ... You fit the punishment to the criminal, not the crime."`
  },
  {
    date: "16 March 1983",
  ...
  },
  {
    ...
    text: `Attorneys Liza Chan and Dan Hoekenga argued before Judge Kaufman to persuade him to vacate his sentence. The ACJ organized 100 people to attend the hearing. It was unsuccessful.`
  },
  {
    date: "9 May 1983",
    title: "Demonstration",
  ...
  },
  {
    ...
    text: `Lily Chin and ACJ representatives went to Washington, D.C. to meet with Department of Justice officials to seek a federal investigation. The FBI began investigating the killing of Chin on July 6.`
  },
  {
    date: "28 June 1984",
    title: "United States v Ebens",
    subtitle: `The Federal Trial Ends`,
    text: `The jury found Ebens guilty of violating Chin's civil rights; Nitz was acquitted. The jury foreperson explained that the "you motherf*ckers" was clear that it was racially motivated. Ebens was sentenced to 25 years in prison.`
  },
  {
    date: "11 September 1986",
    title: "Appeal",
    subtitle: `Ebens won a retrial on appeal`,
    text: `The Sixth Circuit Court of Appeals cited that there was too much pretrial publicity and errors with the audiotapes (which had convinced the Dept. of Justice and the Asian American community of racial motivation). The new trial would be held in the conservative Cincinnati to decrease the chance of jurors having previous knowledge of the case. Eben's conviction was reversed on the appeal.`
  },
  {
    date: "1 May 1987",
    title: "Re-Trial",
    subtitle: `Ebens is Acquitted`,
    text: `Ebens was acquitted by the Cincinnati jury. No jury member had any acquaintance with Asian Americans. Mrs. Chin was devastated and soon moves to her hometown in Guangzhou, China.`
  },
  {
    date: "July 1987",
    title: "Civil Suit",
    subtitle: `Wrongful death civil suit filed`,
    text: `The civil suit, filed on behalf of Lily Chin, ordered Ebens and Nitz to pay $1.5 million to Chin's estate. Ebens later told Christine Choy, filmmaker of the documentary <span style="font-style:italic">Who Killed Vincent Chin?</span>, that Mrs. Chin would never see the money. He stopped making payments in 1989 and never spent a full day in jail. The ACJ has continued advocating for Asian American communities, and the movement surrounding Vincent Chin had sparked the Asian American movement.`
  },
 ];
